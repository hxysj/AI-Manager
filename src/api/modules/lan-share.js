...
export const lanShareApi = {
  ...
  retryMessage: payload => request('lan-share:retry-message', payload),
  setAutoDiscovery: payload => request('lan-share:set-auto-discovery', payload),
  scanDevices: () => request('lan-share:scan-devices'),
